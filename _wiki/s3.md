...
**WARNING** - In Moloch 2.0.1, all reading by moloch-viewer from S3, is NOT work properly due to [S3 plugin issue](https://github.com/aol/moloch/issues/1178).
{: .purp-text}

Waiting to get some feedback or see how we use this before adding a bunch more features.
...
**WARNING** - After Moloch 2.1.0, accesskey-based authentication is not recommended. It should be obtained from EC2 IAM Role.
{: .purp-text}
