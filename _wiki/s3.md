...
* S3 Writer does not support [**maxFileTimeM** configuration](https://molo.ch/settings#basic-settings).
...
After Moloch 2.1.0, you can choice EC2 IAM Role based authentication.
