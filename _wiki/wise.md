...
* Pick a host on the correct networks and checkout moloch, wiseService lives in `/data/moloch/wiseService`
* Initial install can be done with `/data/moloch/bin/Configure --wise` starting with Moloch 0.20.2
...
file=/data/moloch/etc/rightclick-virustotal.ini
```
